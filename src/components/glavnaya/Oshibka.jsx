        ...
        <div className="Forma formaoshibki">
          <div className="conteiner">
            <img className="tochki" src={img7} alt="" />
              <div className="delenieOshibki">
                <div className="pervoedelenie">
                  <h1 className="Text">Ошибка 404</h1>
                  <p1 className="SecondText">Возможно, у вас опечатка в адресе страницы, или её просто не существует</p1>
                  <Link to="/">
