...
export default function Homepage(){
  ...
  localStorage.setItem("gorod","0")
  
    axios.get(`/ArendaCard?city=Минске`).then(({data})=>{
  ...
  const push2 = (item,item2) =>{
    localStorage.setItem("gorod",item)
    localStorage.setItem("kvartiri",`Квартиры на сутки в ${item2}`)
    history.push(`/katalog/city=${item}`)
  }
          ...
          <div className="first__block">
            <div className="block__item">
              ...
              <div className="select__filter">
                <div className={ToggleState===1? "select__filter__item":"select__filter__item__hidden"}>
                  <p className="select__filter__item__css">Город</p>
                    <div className="dropdown">
                      ...
                      <ul className="Spisok__dropdown">
                        ...
                        <li className="dropdown__item" key="Город2">Город 2</li>
                        <li className="dropdown__item" key="Город3">Город 3</li>
                        <li className="dropdown__item" key="Город4">Город 4</li>
                        <li className="dropdown__item" key="Город5">Город 5</li>
                      </ul>
                ...
                <div className={ToggleState===1? "select__filter__item select__filter__item2":"select__filter__item__hidden"}>
                  <div className="raz">
                ...
                <div className={ToggleState===1? "select__filter__item select__filter__item4":"select__filter__item__hidden"}>
                ...
                <h1 className={ToggleState===1? "Razrabotka__hidden":"Razrabotka"}>В разработке</h1>
              </div>
              <div className="DopOpcii">
                <div className="OsnovaOpcii">
                  ...
                  <div className="delenieOpcii">
                    ...
                    <div className="checkbox" style={{display:"flex",marginBottom:"10px",marginTop:"30px"}}>
                      <input type="checkbox" value={"Газовая плита"} id="checkbox1" className="checkBoxOpcii"/> 
                    ...
                    <div className="" style={{display:"flex",marginBottom:"10px"}}>
                      <input type="checkbox" value={"Духовка"} id="checkbox2" className="checkBoxOpcii"/> 
                      <label htmlFor="checkbox2" className="textCheckboxOpcii">Духовка</label>
                    </div>
                    <div className="" style={{display:"flex",marginBottom:"10px"}}>
                      <input type="checkbox" value={"Кофеварка"} id="checkbox3" className="checkBoxOpcii"/> 
                      <label htmlFor="checkbox3" className="textCheckboxOpcii">Кофеварка</label>
                    </div>
                    <div className="" style={{display:"flex",marginBottom:"10px"}}>
                      <input type="checkbox" value={"Микроволновая печь"} id="checkbox4" className="checkBoxOpcii"/> 
                      <label htmlFor="checkbox4" className="textCheckboxOpcii">Микроволновая печь </label>
                    </div>
                    <div className="" style={{display:"flex",marginBottom:"10px"}}>
                      <input type="checkbox" value={"Посуда"} id="checkbox5" className="checkBoxOpcii"/> 
                      <label htmlFor="checkbox5" className="textCheckboxOpcii">Посуда </label>
                    </div>
                    <div className="" style={{display:"flex",marginBottom:"10px"}}>
                      <input type="checkbox" value={"Посудомоечная машина"} id="checkbox6" className="checkBoxOpcii"/> 
                ...
                {/* Второе деление */}
                  <div className="delenieOpcii">
                    ...
                    <div className="checkbox" style={{display:"flex",marginBottom:"10px",marginTop:"30px"}}>
                      <input type="checkbox" value={"Газовая плита"} id="checkbox7" className="checkBoxOpcii"/> 
                      <label htmlFor="checkbox7" className="textCheckboxOpcii">Газовая плита</label>
                    </div>
                    <div className="" style={{display:"flex",marginBottom:"10px"}}>
                      <input type="checkbox" value={"Духовка"} id="checkbox8" className="checkBoxOpcii"/> 
                      <label htmlFor="checkbox8" className="textCheckboxOpcii">Духовка</label>
                    </div>
                    <div className="" style={{display:"flex",marginBottom:"10px"}}>
                      <input type="checkbox" value={"Кофеварка"} id="checkbox9" className="checkBoxOpcii"/> 
                      <label htmlFor="checkbox9" className="textCheckboxOpcii">Кофеварка</label>
                    </div>
                    <div className="" style={{display:"flex",marginBottom:"10px"}}>
                      <input type="checkbox" value={"Микроволновая печь"} id="checkbox10" className="checkBoxOpcii"/> 
                      <label htmlFor="checkbox10" className="textCheckboxOpcii">Микроволновая печь </label>
                    </div>
                    <div className="" style={{display:"flex",marginBottom:"10px"}}>
                      <input type="checkbox" value={"Посуда"} id="checkbox11" className="checkBoxOpcii"/> 
                      <label htmlFor="checkbox11" className="textCheckboxOpcii">Посуда </label>
                    </div>
                    <div className="" style={{display:"flex",marginBottom:"10px"}}>
                      <input type="checkbox" value={"Посудомоечная машина"} id="checkbox12" className="checkBoxOpcii"/> 
                  ...
                  <div className="delenieOpcii">
                    ...
                    <div className="checkbox" style={{display:"flex",marginBottom:"10px",marginTop:"30px"}}>
                      <input type="checkbox" value={"Газовая плита"} id="checkbox13" className="checkBoxOpcii"/> 
                      <label htmlFor="checkbox13" className="textCheckboxOpcii">Газовая плита</label>
                    </div>
                    <div className="" style={{display:"flex",marginBottom:"10px"}}>
                      <input type="checkbox" value={"Духовка"} id="checkbox14" className="checkBoxOpcii"/> 
                      <label htmlFor="checkbox14" className="textCheckboxOpcii">Духовка</label>
                    </div>
                    <div className="" style={{display:"flex",marginBottom:"10px"}}>
                      <input type="checkbox" value={"Кофеварка"} id="checkbox15" className="checkBoxOpcii"/> 
                      <label htmlFor="checkbox15" className="textCheckboxOpcii">Кофеварка</label>
                    </div>
                    <div className="" style={{display:"flex",marginBottom:"10px"}}>
                      <input type="checkbox" value={"Микроволновая печь"} id="checkbox16" className="checkBoxOpcii"/> 
                      <label htmlFor="checkbox16" className="textCheckboxOpcii">Микроволновая печь </label>
                    </div>
                    <div className="" style={{display:"flex",marginBottom:"10px"}}>
                      <input type="checkbox" value={"Посуда"} id="checkbox17" className="checkBoxOpcii"/> 
                      <label htmlFor="checkbox17" className="textCheckboxOpcii">Посуда </label>
                    </div>
                    <div className="" style={{display:"flex",marginBottom:"10px"}}>
                      <input type="checkbox" value={"Посудомоечная машина"} id="checkbox18" className="checkBoxOpcii"/> 
                ...
                {/* Четвертое деление */}
                  <div className="delenieOpcii">
                    <div className="checkbox" style={{display:"flex",marginBottom:"10px",marginTop:"30px"}}>
                        <input type="checkbox" value={"Газовая плита"} id="checkbox19" className="checkBoxOpcii"/> 
                        <label htmlFor="checkbox19" className="textCheckboxOpcii">Газовая плита</label>
                      </div>
                      <div className="" style={{display:"flex",marginBottom:"10px"}}>
                        <input type="checkbox" value={"Духовка"} id="checkbox20" className="checkBoxOpcii"/> 
                        <label htmlFor="checkbox20" className="textCheckboxOpcii">Духовка</label>
                      </div>
                      <div className="" style={{display:"flex",marginBottom:"10px"}}>
                        <input type="checkbox" value={"Кофеварка"} id="checkbox21" className="checkBoxOpcii"/> 
                        <label htmlFor="checkbox21" className="textCheckboxOpcii">Кофеварка</label>
                      </div>
                      <div className="" style={{display:"flex",marginBottom:"10px"}}>
                        <input type="checkbox" value={"Микроволновая печь"} id="checkbox22" className="checkBoxOpcii"/> 
                        <label htmlFor="checkbox22" className="textCheckboxOpcii">Микроволновая печь </label>
                      </div>
                      <div className="" style={{display:"flex",marginBottom:"10px"}}>
                        <input type="checkbox" value={"Посуда"} id="checkbox23" className="checkBoxOpcii"/> 
                        <label htmlFor="checkbox23" className="textCheckboxOpcii">Посуда </label>
                      </div>
                      <div className="" style={{display:"flex",marginBottom:"10px"}}>
                        <input type="checkbox" value={"Посудомоечная машина"} id="checkbox24" className="checkBoxOpcii"/> 
                ...
                {/* Пятое деление */}
                  <div className="delenieOpcii">
                    <div className="checkbox" style={{display:"flex",marginBottom:"10px",marginTop:"30px"}}>
                        <input type="checkbox" value={"Газовая плита"} id="checkbox25" className="checkBoxOpcii"/> 
                        <label htmlFor="checkbox25" className="textCheckboxOpcii">Газовая плита</label>
                      </div>
                      <div className="" style={{display:"flex",marginBottom:"10px"}}>
                        <input type="checkbox" value={"Духовка"} id="checkbox26" className="checkBoxOpcii"/> 
                        <label htmlFor="checkbox26" className="textCheckboxOpcii">Духовка</label>
                      </div>
                      <div className="" style={{display:"flex",marginBottom:"10px"}}>
                        <input type="checkbox" value={"Кофеварка"} id="checkbox27" className="checkBoxOpcii"/> 
                        <label htmlFor="checkbox27" className="textCheckboxOpcii">Кофеварка</label>
                      </div>
                      <div className="" style={{display:"flex",marginBottom:"10px"}}>
                        <input type="checkbox" value={"Микроволновая печь"} id="checkbox28" className="checkBoxOpcii"/> 
                        <label htmlFor="checkbox28" className="textCheckboxOpcii">Микроволновая печь </label>
                      </div>
                      <div className="" style={{display:"flex",marginBottom:"10px"}}>
                        <input type="checkbox" value={"Посуда"} id="checkbox29" className="checkBoxOpcii"/> 
                        <label htmlFor="checkbox29" className="textCheckboxOpcii">Посуда </label>
                      </div>
                      <div className="" style={{display:"flex",marginBottom:"10px"}}>
                        <input type="checkbox" value={"Посудомоечная машина"} id="checkbox30" className="checkBoxOpcii"/> 
                        <label htmlFor="checkbox30" className="textCheckboxOpcii">Посудомоечная машина </label>
                      </div>
                  </div>
                </div>
                <div className="MapConteiner2">
                  <MapSelect/>
                </div>
              </div>
            </div>
              ...
              <div className="second__block__delenie">
                          ...
                          <>
                            {
                              Cities.map((item) => {
                                return(
                                <button className="city" onClick={()=>push2(`${item.city}`,`${item.citySklon}`)}>{item.city}</button>
                                )
                              })  
                            }
                          </>
                ...
                <div className="vtoroe__delenie">
                  ...
                  <div className="vtoroe__delenie__info">
                    <Link to="/katalog/city=Минск" className="vtoroe__delenie__links" onClick={()=>{localStorage.setItem("gorod","Минск");localStorage.setItem("kvartiri",`Квартиры на сутки в Минске`)}}>Квартиры в Минске</Link>
                    <p className="vtoroe__delenie__sec__text">{arendaLength}</p>
                  </div>
                  <div className="vtoroe__delenie__info">
                    <Link to="/katalog/city=Гомель" className="vtoroe__delenie__links" onClick={()=>{localStorage.setItem("gorod","Гомель");localStorage.setItem("kvartiri",`Квартиры на сутки в Гомеле`)}}>Квартиры в Гомеле</Link>
                    <p className="vtoroe__delenie__sec__text">{arendaLength2}</p>
                  </div>
                  <div className="vtoroe__delenie__info">
                    <Link to="/katalog/city=Гродно" className="vtoroe__delenie__links" onClick={()=>{localStorage.setItem("gorod","Гродно");localStorage.setItem("kvartiri",`Квартиры на сутки в Гродно`)}}>Квартиры в Гродно</Link>
                    <p className="vtoroe__delenie__sec__text">{arendaLength3}</p>
                  </div>
                  <div className="vtoroe__delenie__info">
                    <Link to="/katalog/city=Могилев" className="vtoroe__delenie__links" onClick={()=>{localStorage.setItem("gorod","Могилев");localStorage.setItem("kvartiri",`Квартиры на сутки в Могилеве`)}}>Квартиры в Могилеве</Link>
                    <p className="vtoroe__delenie__sec__text">{arendaLength4}</p>
                  </div>
                  <div className="vtoroe__delenie__info">
                    <Link to="/katalog/city=Брест" className="vtoroe__delenie__links"onClick={()=>{localStorage.setItem("gorod","Брест");localStorage.setItem("kvartiri",`Квартиры на сутки в Бресте`)}}>Квартиры в Бресте</Link>
                    <p className="vtoroe__delenie__sec__text">{arendaLength5}</p>
                  </div>
                  <div className="vtoroe__delenie__info">
                    <Link to="/katalog/city=Витебск" className="vtoroe__delenie__links"onClick={()=>{localStorage.setItem("gorod","Витебск");localStorage.setItem("kvartiri",`Квартиры на сутки в Витебске`)}}>Квартиры в Витебск</Link>
                  ...
                  <div className="vtoroe__delenie__info">
                    <Link to="123" className="vtoroe__delenie__links">Еще</Link>
                  ...
                  <div className="ColRowHome conteiner" style={{position:"absolute",
                    ...
                    <div className="predlojenia">
                      <div className="chislo__predlojenie">
                        <h1 className="kol-vo__predlojeniy">{arendaLength} <span style ={{color:"#664EF9"}}>+</span></h1>
