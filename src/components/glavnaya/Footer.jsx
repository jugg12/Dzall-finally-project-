              ...
              <div className="info2">
                ...
                <div className="info2__delenie">
                  <div className="delenie1">
                    <Link to = "" className="info2__text">Квартиры в Минске</Link>
                    <Link to = "" className="info2__text">Квартиры в Гомеле</Link>
                    <Link to = "" className="info2__text">Квартиры в Бресте</Link>
                  </div>
                  <div className="delenie1 delenie2">
                    <Link to = "" className="info2__text">Квартиры в Витебске</Link>
                    <Link to = "" className="info2__text">Квартиры в Гродно</Link>
                    <Link to = "" className="info2__text">Квартиры в Могилеве</Link>
                  </div>
                </div>
              </div>
              <div className="info3">
                <Link to = "" className="info3__text">Новости</Link>
                <Link to = "" className="info3__text">Размещение и тарифы</Link>
                <Link to = "" className="info3__text">объявления на карте</Link>
                <Link to = "" className="info3__text">Контакты</Link>
              </div>
            </div>
