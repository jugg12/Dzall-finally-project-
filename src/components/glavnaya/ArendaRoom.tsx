...
const ArendaRoom=(link)=>{
  ...
  return(
          ...
          <div className="CardOsnova">
            ...
            <Card.Body className="bodyCard" >
              <Card.Title className="card__title">
                <div className="perviytitle">
                  <div className="stoimostobshaya">
                    <div className="stoimost">{item.sent}</div>
                  ...
                  <div className="kolvoludey komnati">{item.komnati}</div>
                ...
                <div className="vtoroytitle">
                  <div className="adresall">
                    ...
                    <path d="M12.462 3.15505C11.3632 1.42457 9.54923 0.451172 7.50853 0.451172C5.48528 0.451172 3.67132 1.42457 2.5376 3.15505C1.40388 4.84949 1.14225 7.01259 1.83993 8.90531C2.03179 9.41004 2.3283 9.93279 2.71202 10.4015L7.12481 15.7732C7.22946 15.8813 7.33412 15.9534 7.49109 15.9534C7.64807 15.9534 7.75272 15.8813 7.85737 15.7732L12.2876 10.4015C12.6713 9.93279 12.9853 9.42806 13.1597 8.90531C13.8574 7.01259 13.5957 4.84949 12.462 3.15505ZM7.50853 9.53622C6.00853 9.53622 4.77016 8.25638 4.77016 6.70615C4.77016 5.15593 6.00853 3.87609 7.50853 3.87609C9.00853 3.87609 10.2469 5.15593 10.2469 6.70615C10.2469 8.25638 9.02598 9.53622 7.50853 9.53622Z" fill="#BDBDBD"/>
                    </g>
                    <defs>
                    <clipPath id="clip0_2831_1895">
                    <rect width="15" height="15.5023" fill="white" transform="translate(0 0.451172)"/>
                    </clipPath>
                    </defs>
                    </svg>
                    </div>
              ...
              <Card.Text className="card__text">
                <div className="opisanie">{item.opisanie}</div>
              </Card.Text> 
                <div className="btnkontaktiOsnova">
                  <Button variant="primary" className="kontaktibtn" onClick={btnclick}>
                    
                      <div className="btnall">
                        <div className="btniconkontakti">
                          <svg className="telbtnicon" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <Button className="Podrobneebtn">
                <div className="Podrobnee">
                    <p className="textPodrobnee">Подробнее</p>
                </div>
                </Button>
              </div>
            </Card.Body>
    ...
    <div className="btnsarrows" style={{textAlign:"center",position: "absolute", left: "49.5%", zIndex: "2"}}>
