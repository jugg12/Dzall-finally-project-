...
const Header = () =>{
  return(
       ...
       <nav>
            ...
            <div className="VerhNav">
              <div className="leftpart">
                ...
                <Link to="/registraciya/registraciya"className="item">Новости</Link>
                <Link to="/registraciya/registraciya"className="item">Размещение и тарифы</Link>
                ...
                <Link to="/registraciya/registraciya"className="item">Объявления на карте</Link>
                <Link to="/kontakti"className="item" >Контакты</Link>
              </div>
              <div className="rightpart">
                <Link to="/registraciya/registraciya"className="item item3">Закладки</Link>
                  <svg className="icon" сxmlns="http://www.w3.org/2000/svg" height="14.23px" viewBox="0 0 24 24" width="24px" fill="#8291A3">
    ...
    <div className="conteiner">
          ...
          <div className="group">
            <Link to="" className="Items">Квартиры на сутки</Link>
