...
import Otpravka from "../registraciya/otpravka";

import otpravka from "./otpravka";
import axios from "../../../axios"

const Registraciya = ({user,setUser}) =>{
...
return(
    <div className="Forma">
    <form className="Regforma" onSubmit={signUp}>
        ...
        <div className="Osnovnoe">
          <h1 className="Avtorization">Регистрация</h1>
            <div className="LogPass">
              ...
              <div className="MAIL">
                <input class="mail" name = "Mail" type="mail" placeholder="Электронная почта" />
              ...
              <div className="PASSWORD2">
                <input class="password2" name = "Password2" type="password" placeholder="Повторите пароль" />
          ...
          <div className="Zabil">
            {/* <Recaptcha
            sitekey="6LdcMwEjAAAAAPGQF1LjlPym5aBKU0KeKx-EByin"
            render="explicit"
            onloadCallback={recaptchaLoaded()}
            /> */}
          </div>
          {/* <Link to="/otpravka"> */}
          <button className="Voyti" id="btn">Зарегистрироваться</button>
          {/* </Link>  */}
        </div>
        <div className="Dop">
          <p>Пользователь обязуется:</p>
          <ul className="osntext" type="disc">
