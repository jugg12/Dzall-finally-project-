...
const Vhod = ({user,setUser}) =>{
  ...
  .then((res)=>{  
    ...
    if(res.data.length===0){
      console.log("Неверный логин либо пароль");
    }
    else{
      history.push("/");
  ...
  return(
    ...
    <div className="Forma">
      <form onSubmit={signIN} className="Vhodforma">
        <div className="Osnovnoe">
          ...
          <p className="Primech"> публиковать свои объявления</p>
            <div className="LogPass">
              <div className="LOGIN">
                <input class="login" name = "Login" id="login" type="text" placeholder="Логин" />
              ...
              <div className="PASSWORD">
                <input class="password" name = "Password" id="password" type="password" placeholder="Пароль" />
          ...
          <button className="Voyti" onSubmit={signIN}>Войти</button>
          <div className="last2">
