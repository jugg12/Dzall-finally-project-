...
export default function katalog(link){
            ...
            <nav className="breadcrumbs" style={{display:"flex"}}>
              ...
              <Link to="/katalog/city" style={{textDecoration:"none"}}>
                <div className="katalogLink">
                  <p className="LinkText">Каталог</p>
                </div>
              </Link>
            </nav>
          </div>
              ...
              <div className="categories" style={{justifyContent:"flex-start"}}>
                {
                  categories.map((item)=>{
                    return(
                      <div className="categoriesBtn" id={item.id} onClick={()=>categoriaClick(item.id)}>
        ...
        <div className="conteiner">
          <div className="allitemsselectkatalog">
            ...
            <div className=" select__filter__item2">
              <button className="clearAll">Очистить</button>
            </div>
            <div className=" 2">
              <button className="Pokazat" >
                <div className="btnarrow">
                  ...
                  <path d="M7.125 14.25L11.875 9.5L7.125 4.75" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                  </svg>
      ...
      <div className="thirdOsnovnoe">
        <div className="conteiner">
          <div className="delenieThirdKatalog">
            <div className="dropdown">
              <button className="Spisok Spisok2" onClick={click}>
                <svg style={{marginRight:"10px"}} width="15" height="16" viewBox="0 0 15 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <g clip-path="url(#clip0_2831_2828)">
                  <g opacity="0.6">
