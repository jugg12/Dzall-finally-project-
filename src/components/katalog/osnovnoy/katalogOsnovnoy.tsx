...
export default function KatalogOsnovnoy(){
  ...
  const push = (item,item2) =>{
    history.push(`/katalog/city=${item2}/${item}`)
  }
  ...
  return(
    <>
      {
        Arenda.length ? currentPage.map((item)=>Loading?<CardSkeleton/>:( 
                ...
                <div className="CardOsnova">
                  ...
                  <Card.Body className="bodyCard" >
                    ...
                    <Card.Text className="card__text">
                      ...
                      <div className="heart" id={`heart-${item.id}`} onClick={()=>clickHeart(item.id)}>
                      ...
                      <Button variant="primary" className="Podrobneebtn Podrobneebtn2">
