...
export default function katalogSpiskom(){
  ...
  const handlepageclick = (e) =>{
    const newOffset = (e.selected*KatalogPerPage)%Arenda.length;
    setItemOffset(newOffset)
  }


  const push = (item) =>{
    history.push(`/katalog/${item}`)
  }
  ...
  useEffect(()=>{
    ...
    setCountPage(Math.ceil(Arenda.length/KatalogPerPage));
    setCurrentPage(Arenda.slice(itemOffset,endoffset));
  },[itemOffset,KatalogPerPage,Arenda])

  const clickHeart = (value)=>{
    const text = document.getElementById(`textHeart-${value}`)
    const heart= document.getElementById(`heart__svg-${value}`)
    if(text.textContent=="В закладки"){
  ...
  return(
    <>
            {
              Arenda.length ? currentPage.map((item)=>( 
            <Row> 
                ...
                <Card className="card__style" style={{width:"100%",height:"300px"}}>
                  <div className="SpisokInformKontakti">  
                    <div className="CardOsnova" style={{display: "flex"}}>
                      ...
                      <div className="">
                      <Card.Img  className="imgCard" style={{ height: "300px",width: "444px"}} src={item.url}/>
                      </div>
                      <Card.Body className="bodyCard" >
                        <Card.Title className="card__title">
                          <div className="perviytitle">
                            ...
                            <div className="stoimostobshaya">
                              <div className="stoimost">{item.sent} BYN</div>
                        ...
                        <Card.Text className="card__text card__text2">
                          ...
                          <div className="btnkontaktiOsnova" style={{border:"none",padding:0,marginTop:"24px"}}>
                            <div className="btnKontaktiHeart">
                              <div className="dropdownKontakti">
                                ...
                                <div className="informkontakti" style={{top:"-24%",left:"24%"}} id={item.id}>
                              ...
                              <div className="heart2" id={`heart2-${item.id}`} onClick={()=>clickHeart(item.id)}>
